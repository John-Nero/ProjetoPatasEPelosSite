            ...
            <div class="site">
                <div class="topo-servico">
                    <div class="topo-servico-textos">
                        ...
                        <p class="wow animate__animated animate__fadeIn">E ache o que melhor se encaixa <br> com voce:</p>
                    </div>
                </div>
            </div>
        ...
        <section class="fundo_site">
            <div class="site">
                ...
                <div class="teste1">
                    ...
                    <span class="fade_batata2 wow animate__animated animate__fadein"><img src="img/enfeites/bolota2.svg" alt="" /> </span>
        ...
        <section class="site">
            <div class="contato">
                <div>
                    ...
                    <h2 class="subtitulo_laranja wow animate__animated animate__flipInX" data-wow-delay:="3s">E faça o seu pet<br> feliz.</h2>
